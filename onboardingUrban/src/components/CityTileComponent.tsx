...
export const CityTileComponent: FC<CityTileProps> = ({
  ...
  <Pressable
    ...
    accessibilityHint="city weather"
    onPress={onPress}
  ...
  >
    <View style={styles.leftSectionContainer}>
      <View>
        <Image
          accessibilityHint="weather icon"
          source={{
      ...
      <View style={styles.cityNameAndStatusContainer}>
        <Text style={styles.cityNameLabel} accessibilityHint="city name">
          {cityName}
        </Text>
        <Text
          style={styles.weatherStatusLabel}
          accessibilityHint="weather status"
        >
          {weatherStatus}
        </Text>
      </View>
    ...
    <View style={styles.rightSectionContainer}>
      <View style={styles.temperatureLabelContainer}>
        <Text style={styles.temperatureText} accessibilityHint="temperature">
          {temperature}
        </Text>
      ...
      {onPress && (
        <Icon
          accessibilityHint="show details icon"
